...
pip install Django pymysql daphne  django-cors-headers drf-yasg djangorestframework-simplejwt openpyxl scrapy scrapy-splash scrapy-playwright requests user_agents pandas channels coreapi django-ratelimit uvicorn captcha graphic-verification-code

playwright install   安装playwright浏览器 linux
playwright install chromium  只安装chromium默认chromium
