<template>
  <div class="chat">
    <div class="chat-container translate">
      <div class="header">
        <svg style="width: 32px;height: 32px;" viewBox="0 0 1318 1024" version="1.1" xmlns="http://www.w3.org/2000/svg">
          <path
          ...
          <path
            ...
            fill="#612273" opacity=".2" p-id="10994"></path>
          <path
          ...
          <path
            ...
            fill="#EB3D72" opacity=".5" p-id="10996"></path>
          <path
      ...
      <message :data="attrs.data" :userId="user_info.id"></message>
      <div id="chat-footer" class="footer">

        <el-input id="emojiInput" v-model="attrs.content" type="textarea" :autosize="{ minRows: 1, maxRows: 4 }"
          placeholder="请输入内容" @keydown.enter="submit_"></el-input>
        ...
        <svg width="18" height="18" @click="send_message" viewBox="0 0 1025 1024" version="1.1"
          xmlns="http://www.w3.org/2000/svg" p-id="15072">
          <path
...
import websocket from '../../hooks/websocket.js'
import message from './message.vue';
const props = defineProps(['group', 'user_info']); //子向父传数据
  ...
  data: [
    {
      id: '1',
      username: 'username',
      icon: 'https://himg.bdimg.com/sys/portraitn/item/public.1.da030722.RWQ6LfbSEhr7eaQMgs-xJg',
      content: 'content',
    },
    {
      id: '2',
...
const onmessage = (data) => {
  attrs.data.push(JSON.parse(data))
}

const send_message = () => {
  // console.log(websocket_);
  websocket_.send(JSON.stringify({
    id: props.user_info.id,
    username: props.user_info.username,
    content: attrs.content,
    icon: props.user_info.icon,
    group: props.group,
  }));
}
websocket(props.group, props.user_info.id, onmessage, onclose).then((r) => {
  websocket_ = r
})
const submit_ = () => {
